<?php /* Smarty version Smarty-3.1.16, created on 2014-02-20 15:37:01
         compiled from ".\templates\money.html" */ ?>
<?php /*%%SmartyHeaderCode:3211453062051aa2715-01685456%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8b81add9c281b6a1720ce4b63f90cc7884b27a64' => 
    array (
      0 => '.\\templates\\money.html',
      1 => 1392910618,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3211453062051aa2715-01685456',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53062051b754f4_99110315',
  'variables' => 
  array (
    'cookie' => 0,
    'list' => 0,
...
<?php if ($_valid && !is_callable('content_53062051b754f4_99110315')) {function content_53062051b754f4_99110315($_smarty_tpl) {?>
...
<link rel="shortcut icon" href="./templates/styles/index/images/favicon.ico" />
    ...
    <div class="group gp1">
		...
		<div class="mod mod-searchBar" >
			  ...
			  <div class="mod mod-ksfw" style="height: 240px;">
                <ul>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="class.html">信托知识</a></li>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="money.html">理财知识</a></li>
    ...
    <div class="group gp2" style="width:720px;">
      <div class="mod mod-cpxx mod02" >
        <div class="mhd" style="background: url(./templates/img/lanmu.png) 0 -94px no-repeat;"> 
          <h2>理财知识<?php if ($_smarty_tpl->tpl_vars['cookie']->value) {?><a href="cp.php?op=money" style="float:right;color:#333;">发布</a><?php }?></h2>
        </div>
            <div class="mbd">
...
&op=money'  title='<?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec1']['index']]['subject'];?>
'>
