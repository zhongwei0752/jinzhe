<?php /* Smarty version Smarty-3.1.16, created on 2014-02-20 15:00:23
         compiled from ".\templates\message.html" */ ?>
<?php /*%%SmartyHeaderCode:3218253057361d51317-38955404%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b4deeda019a9c892467273094f8c884b35de741b' => 
    array (
      0 => '.\\templates\\message.html',
      1 => 1392908421,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3218253057361d51317-38955404',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53057361dcc744_34551690',
  'variables' => 
  array (
    'cookie' => 0,
    'list' => 0,
...
<?php if ($_valid && !is_callable('content_53057361dcc744_34551690')) {function content_53057361dcc744_34551690($_smarty_tpl) {?>
    ...
    <div class="group gp1">
		...
		<div class="mod mod-searchBar" >
			  ...
			  <div class="mod mod-ksfw" style="height: 240px;">
                <ul>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="list.php?op=message">通知公告</a></li>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="list.php?op=show">信息披露</a></li>
    ...
    <div class="group gp2" style="width:720px;">
      <div class="mod mod-cpxx mod02" >
        <div class="mhd" style="background: url(./templates/img/lanmu.png) 0 -94px no-repeat;"> 
          <h2>通知公告<?php if ($_smarty_tpl->tpl_vars['cookie']->value) {?><a href="cp.php?op=message" style="float:right;color:#333;">发布</a><?php }?></h2>
        </div>
            <div class="mbd">
...
&op=message'  title='<?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec1']['index']]['subject'];?>
'>
