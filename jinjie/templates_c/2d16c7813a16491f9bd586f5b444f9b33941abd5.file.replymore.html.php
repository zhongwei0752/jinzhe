<?php /* Smarty version Smarty-3.1.16, created on 2014-02-20 15:08:08
         compiled from ".\templates\replymore.html" */ ?>
<?php /*%%SmartyHeaderCode:291765305b647962a50-22023230%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d16c7813a16491f9bd586f5b444f9b33941abd5' => 
    array (
      0 => '.\\templates\\replymore.html',
      1 => 1392908881,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '291765305b647962a50-22023230',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5305b647a28120_51557600',
  'variables' => 
  array (
    'list' => 0,
    'pageup' => 0,
...
<?php if ($_valid && !is_callable('content_5305b647a28120_51557600')) {function content_5305b647a28120_51557600($_smarty_tpl) {?>
...
<div class="pbd" style="height:520px;">
    ...
    <div class="group gp1">
		...
		<div class="mod mod-searchBar" >
			  ...
			  <div class="mod mod-ksfw" style="height: 240px;">
                <ul>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="custom.html">在线客服</a></li>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="reply.html">客户留言</a></li>
...
?>
                <li style="line-height:6px;">
                    ...
                    <a href='replymoremore.php?id=<?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec1']['index']]['id'];?>
'  title='<?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec1']['index']]['subject'];?>
'>
                    <?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec1']['index']]['subject'];?>
(<?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec1']['index']]['qclass'];?>
)</a>
                </li>
　　          
　　          <?php endfor; endif; ?>
