<?php /* Smarty version Smarty-3.1.16, created on 2014-02-20 15:04:35
         compiled from ".\templates\company.html" */ ?>
<?php /*%%SmartyHeaderCode:2925753057bb8929986-68673921%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '18bbc9af86d5c9b272c91bbabcbeb2befd20b3cb' => 
    array (
      0 => '.\\templates\\company.html',
      1 => 1392908673,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2925753057bb8929986-68673921',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53057bb89e2b27_28334721',
  'variables' => 
  array (
    'cookie' => 0,
    'list' => 0,
...
<?php if ($_valid && !is_callable('content_53057bb89e2b27_28334721')) {function content_53057bb89e2b27_28334721($_smarty_tpl) {?>
    ...
    <div class="group gp1">
		...
		<div class="mod mod-searchBar" >
			  ...
			  <div class="mod mod-ksfw" style="height: 240px;">
                <ul>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="list.php?op=news">业内新闻</a></li>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="list.php?op=focus">财经聚焦</a></li>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="list.php?op=company">公司新闻</a></li>
    ...
    <div class="group gp2" style="width:720px;">
      <div class="mod mod-cpxx mod02" >
        <div class="mhd" style="background: url(./templates/img/lanmu.png) 0 -94px no-repeat;"> 
         <h2>公司新闻<?php if ($_smarty_tpl->tpl_vars['cookie']->value) {?><a href="cp.php?op=focus" style="float:right;color:#333;">发布</a><?php }?></h2>
        </div>
            <div class="mbd">
...
&op=focus'  title='<?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sec1']['index']]['subject'];?>
'>
