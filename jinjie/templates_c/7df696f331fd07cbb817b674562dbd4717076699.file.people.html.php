<?php /* Smarty version Smarty-3.1.16, created on 2014-02-24 14:30:13
...
<?php if ($_valid && !is_callable('content_5305d32ead5ed0_85237110')) {function content_5305d32ead5ed0_85237110($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
    ...
    <div class="group gp2" style="width:720px;">
      <div class="mod mod-cpxx mod02" >
        <div class="mhd" style="background: url(./templates/img/lanmu.png) 0 -94px no-repeat;"> 
          <h2>人员招聘<?php if ($_smarty_tpl->tpl_vars['cookie']->value) {?><a href="cp.php?op=people" style="float:right;color:#333;">发布</a><?php }?></h2>
        </div>
            <div class="mbd">
