<?php /* Smarty version Smarty-3.1.16, created on 2014-02-21 08:15:32
         compiled from ".\templates\people.html" */ ?>
<?php /*%%SmartyHeaderCode:325255305d32ea17f32-13052583%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7df696f331fd07cbb817b674562dbd4717076699' => 
    array (
      0 => '.\\templates\\people.html',
      1 => 1392970531,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '325255305d32ea17f32-13052583',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5305d32ead5ed0_85237110',
  'variables' => 
  array (
    'cookie' => 0,
    'list' => 0,
...
<?php if ($_valid && !is_callable('content_5305d32ead5ed0_85237110')) {function content_5305d32ead5ed0_85237110($_smarty_tpl) {?>
...
<div class="phd">
    ...
    <ul class="nav">
        ...
        <li><a href="list.php?op=custom">客服中心</a></li>
    ...
    <div class="group gp1">
		...
		<div class="mod mod-searchBar" >
			  ...
			  <div class="mod mod-ksfw" style="height: 240px;">
                <ul>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="list.php?op=people">人员招聘</a></li>
                  <li style="background: url(./templates/img/ksfw.fw.png) no-repeat;"><a href="list.php?op=activity">公司活动</a></li>
    ...
    <div class="group gp2" style="width:720px;">
      <div class="mod mod-cpxx mod02" >
        <div class="mhd" style="background: url(./templates/img/lanmu.png) 0 -94px no-repeat;"> 
          <h2>人员招聘<?php if ($_smarty_tpl->tpl_vars['cookie']->value) {?><a href="cp.php?op=focus" style="float:right;color:#333;">发布</a><?php }?></h2>
        </div>
            <div class="mbd">
